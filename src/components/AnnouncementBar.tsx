...
export default function AnnouncementBar() {
  ...
  return (
    <div className="announcement-bar bg-[#2c1a11] text-[#fcf9f4] border-b border-[#d3c3bd]/20 px-4 py-2 text-center text-xs tracking-wide">
      <div className="max-w-[1640px] mx-auto px-4 md:px-10 lg:px-12 xl:px-16 flex flex-col md:flex-row items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span>
            Experience Studios: <strong className="font-semibold text-white">100ft Rd Indiranagar</strong> &amp; <strong className="font-semibold text-white">Sky Level VR Whitefield</strong> — Mon to Sun 11am–8pm
          </span>
        </div>
